<?php function vif_searchfield( $atts, $content = null ) {
	
  $atts = vc_map_get_attributes( 'vif_searchfield', $atts );
  extract( $atts );
...
vif_add_short('vif_searchfield', 'vif_searchfield');