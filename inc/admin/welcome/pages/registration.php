			...
			<div class="steps2">
				...
				<div class="thb-box thb-right">
					...
					<div>
						...
						<a class="button thb-change-domain button-primary" href="<?php echo Theme_Config()->dashboardUrl(); ?>" target="_blank">Change Domain Name</a>
					</div>
				</div>
			</div>
			...
			<ul class="steps">
				<li>
					<div class="step">
						...
						<a class="button thb-generate" href="<?php echo Theme_Config()->dashboardUrl(); ?>" target="_blank">Generate a Product Key</a>
					</div>
				</li>
				<li>
					<div class="step">
						...
						<div class="thb-form">
							...
							<button class="button button-primary thb-register" type="submit" data-verify="<?php echo Theme_Config()->dashboardUrl('verify'); ?>" data-domain="<?php echo get_site_url(); ?>">Activate</button>
						</div>
