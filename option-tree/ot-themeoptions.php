...
function thb_custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        'label'       => esc_html__('Catalog Mode', 'viftech'),
        'id'          => 'shop_catalog_mode',
        'type'        => 'on_off',
        'desc'        => esc_html__('If enabled, this will hide add to cart buttons and prices along the site.', 'viftech'),
        'section'     => 'shop',
        'std'         => 'off'
      ),
      array(
        'label'       => esc_html__('Product Listing Style', 'viftech'),
        'id'          => 'shop_product_listing',
        'type'        => 'radio',
        'desc'        => esc_html__('Which style would you like to use on listing pages?', 'viftech'),
        'choices'     => array(
          array(
      ...
      array(
        'label'       => esc_html__('Product Listing Layout', 'viftech'),
        'id'          => 'shop_product_listing_layout',
        'type'        => 'radio',
        'desc'        => esc_html__('Which layout would you like to use on listing pages?', 'viftech'),
        'choices'     => array(
          array(
            'label'       => esc_html__('Grid', 'viftech'),
            'value'       => 'style1'
          ),
          array(
            'label'       => esc_html__('Alternating - 3 / 4 columns', 'viftech'),
            'value'       => 'style2'
          ),
          array(
            'label'       => esc_html__('Alternating - 4 / 5 columns', 'viftech'),
            'value'       => 'style3'
          ),
          array(
            'label'       => esc_html__('Alternating - 5 / 6 columns', 'viftech'),
            'value'       => 'style4'
          ),
          array(
            'label'       => esc_html__('Alternating - 4 / 3 columns', 'viftech'),
            'value'       => 'style5'
          ),
          array(
            'label'       => esc_html__('Alternating - 5 / 4 columns', 'viftech'),
            'value'       => 'style6'
          ),
          array(
            'label'       => esc_html__('Alternating - 6 / 5 columns', 'viftech'),
            'value'       => 'style7'
          ),
          array(
            'label'       => esc_html__('Alternating - 4 / 4 / 3 columns', 'viftech'),
            'value'       => 'style8'
          )
        ),
        'std'         => 'style1',
      ...
      array(
        ...
        'choices'     => array(
          array(
            'label'       => esc_html__('2 Columns', 'viftech'),
            'value'       => 'large-6'
          ),
          array(
            'label'       => esc_html__('3 Columns', 'viftech'),
            'value'       => 'large-4'
          ),
          array(
            'label'       => esc_html__('4 Columns', 'viftech'),
            'value'       => 'large-3'
          ),
          array(
      ...
      array(
        'label'       => esc_html__('Product Pagination Style', 'viftech'),
        'id'          => 'shop_product_listing_pagination',
        'type'        => 'radio',
        'desc'        => esc_html__('Which pagination syle would you like to use on shop page?', 'viftech'),
        'choices'     => array(
          array(
            'label'       => esc_html__('Regular Pagination', 'viftech'),
            'value'       => 'style1'
          ...
          array(
            'label'       => esc_html__('Infinite Load', 'viftech'),
            'value'       => 'style3'
          )
        ),
        'std'         => 'style1',
      ...
      array(
        'label'       => esc_html__('Products Per Page', 'viftech' ),
      ...
      array(
        'label'       => esc_html__('Product Hover Image', 'viftech'),
        'id'          => 'shop_product_hover',
        'type'        => 'on_off',
        'desc'        => esc_html__('When enabled, this shows a secondary product image on hover.', 'viftech'),
        'section'     => 'shop',
        'std'         => 'on'
      ),
      array(
        'id'          => 'shop_tab2',
        'label'       => esc_html__('Product Page', 'viftech'),
        'type'        => 'tab',
        'section'     => 'shop'
      ),
      array(
        'label'       => esc_html__('Product Page Style', 'viftech'),
        'id'          => 'shop_product_style',
        'type'        => 'radio',
        'desc'        => esc_html__('Which style would you like to use on product pages?', 'viftech'),
        'choices'     => array(
          array(
            'label'       => esc_html__('Style 1', 'viftech'),
            'value'       => 'style1'
      ...
      array(
        'label'       => esc_html__('Use Lightbox or Zoom?', 'viftech'),
        'id'          => 'shop_product_lightbox',
        'type'        => 'radio',
        'desc'        => esc_html__('Would you like to use a lightbox or a mouse hover zoom?', 'viftech'),
        'choices'     => array(
          array(
      ...
      array(
        'id'          => 'shop_tab4',
        'label'       => esc_html__('Shop Header', 'viftech'),
        'type'        => 'tab',
        'section'     => 'shop'
      ),
      array(
        'label'       => esc_html__('Shop Page Header Style', 'viftech'),
        'id'          => 'shop_header_style',
        'type'        => 'radio',
        'desc'        => esc_html__('This changes the look of the header on main shop page.', 'viftech'),
        'choices'     => array(
          array(
            'label'       => esc_html__('Just Text', 'viftech'),
            'value'       => 'style1'
          ...
          array(
            'label'       => esc_html__('With Image', 'viftech'),
            'value'       => 'style2'
          )
      ...
      array(
        'label'       => esc_html__('Shop Header Background', 'viftech'),
        'id'          => 'shop_header_bg',
        'type'        => 'background',
        'desc'        => esc_html__('Background settings for the shop header', 'viftech'),
        'section'     => 'shop',
        'condition'   => 'shop_header_style:is(style2)'
      ),
      array(
        'label'       => esc_html__('Shop Header Color', 'viftech'),
        'id'          => 'shop_menu_color',
        'type'        => 'radio',
        'desc'        => esc_html__('What color would you like to display for the header? <small>You can change category headers on individual Edit Category pages</small>', 'viftech'),
        'choices'     => array(
          array(
      ...
      array(
        'id'          => 'shop_tab5',
        'label'       => esc_html__('Misc', 'viftech'),
        'type'        => 'tab',
        'section'     => 'shop'
      ),
      array(
        'label'       => esc_html__('Product "Just Arrived" Badge time', 'viftech'),
        'id'          => 'shop_newness',
        'type'        => 'radio',
        'desc'        => esc_html__('Products that are added before the below time will display the new product page', 'viftech'),
        'choices'     => array(
          array(
            'label'       => esc_html__('Never - "Just Arrived" Badge will never be shown', 'viftech'),
            'value'       => '0'
          ),
          array(
          ...
          array(
            'label'       => esc_html__('2 Days', 'viftech'),
            'value'       => '2'
          ),
          array(
            'label'       => esc_html__('3 Days', 'viftech'),
            'value'       => '3'
          ),
          array(
            'label'       => esc_html__('1 Week', 'viftech'),
            'value'       => '7'
          ),
          array(
            'label'       => esc_html__('2 Weeks', 'viftech'),
            'value'       => '14'
          ),
          array(
            'label'       => esc_html__('3 Weeks', 'viftech'),
            'value'       => '21'
          ),
          array(
            'label'       => esc_html__('1 Month', 'viftech'),
            'value'       => '30'
          )
        ),
        'std'         => '7',
