<?php function vif_cascading( $atts, $content = null ) {
	$atts = vc_map_get_attributes( 'vif_cascading', $atts );
	extract( $atts );
...
vif_add_short('vif_cascading', 'vif_cascading');