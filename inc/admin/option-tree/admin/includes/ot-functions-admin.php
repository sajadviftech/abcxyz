...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 'ace-editor', OT_URL . 'assets/js/vendor/ace/ace.js', null, '1.2.9' );   

    /* load jQuery UI timepicker addon */
    wp_enqueue_script( 'jquery-ui-timepicker', OT_URL . 'assets/js/vendor/jquery/jquery-ui-timepicker.js', array( 'jquery', 'jquery-ui-slider', 'jquery-ui-datepicker' ), '1.6.3' );
...
if ( ! function_exists( 'ot_import' ) ) {
  ...
  function ot_import() {
    ...
    if ( isset( $_POST['import_data_nonce'] ) && wp_verify_nonce( $_POST['import_data_nonce'], 'import_data_form' ) && (isset( $_POST['import_data']) && $_POST['import_data'] !== '') 
    ) {
      /* default message */
      $message = 'failed';
