<?php function vif_video_lightbox( $atts, $content = null ) {
	$atts = vc_map_get_attributes( 'vif_video_lightbox', $atts );
	extract( $atts );
...
vif_add_short('vif_video_lightbox', 'vif_video_lightbox');