<?php function vif_location( $atts, $content = null ) {
	$atts = vc_map_get_attributes( 'vif_location', $atts );
	extract( $atts );
	...
	if ($marker_image) {
		...
		$marker_image = Theme_Config::$vif_theme_directory_uri. 'assets/img/pin.png';
...
vif_add_short('vif_location', 'vif_location');