<?php function vif_portfolio_slider( $atts, $content = null ) {
  $atts = vc_map_get_attributes( 'vif_portfolio_slider', $atts );
  extract( $atts );
...
vif_add_short('vif_portfolio_slider', 'vif_portfolio_slider');