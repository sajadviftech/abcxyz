<?php function thb_testimonial_parent( $atts, $content = null ) {
	...
	?>
	<div id="<?php echo esc_attr($element_id); ?>" class="<?php echo esc_attr(implode(' ', $el_class)); ?>" data-columns="<?php echo esc_attr($thb_testimonial_columns); ?>" data-pagination="<?php echo esc_attr($pagination); ?>" data-navigation="<?php echo esc_attr($navigation); ?>"<?php if ($thb_style === 'style3') { ?> data-center="true"<?php } ?> data-autoplay="<?php echo esc_attr($autoplay); ?>" data-autoplay-speed="<?php echo esc_attr($autoplay_speed); ?>" data-fade="<?php echo esc_attr($fade); ?>">
