...
<div class="vif-carousel post-gallery post-gallery-detail center-arrows" data-pagination="true" data-navigation="true" data-columns="1">
<?php 
	if ($post_gallery_photos) { foreach ($post_gallery_photos_arr as $image_id) {
		$image_caption = get_post($image_id)->post_excerpt;
		$image_url = wp_get_attachment_image_src($image_id, 'full');
?>
	<figure class="vif-overlay-caption">
